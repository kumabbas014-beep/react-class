          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-52 bg-[#1c2541] border border-white/10 rounded-2xl shadow-2xl p-2 z-50 animate-fadeIn">
                ...
                <button onClick={() => alert('Created with ❤️ by Kumail Abbas')} className="w-full text-left px-3 py-2 text-sm rounded-xl hover:bg-white/5 transition-colors flex items-center gap-2 text-white" href="../">
                  🚀 Who Made This?
                </button>
              </div>
            )}
